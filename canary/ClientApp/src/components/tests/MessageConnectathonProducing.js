...
export class MessageConnectathonProducing extends Component {
  ...
  constructor(props) {
    ...
    this.state = { ...this.props, certificateNumber, record: null, message: null, response: null, loading: false, running: false };
    ...
    this.setState({ running: true }, () => {
      axios
        ...
        .then(function(response) {
            ...
            self.setState({ response: response.data, loading: false });
        ...
        {!!this.state.test && this.state.test.completedBool && (
          <React.Fragment>           
            <Grid.Row>
              <Container fluid>
                <Divider horizontal />
                <Header as="h2" dividing id="step-0">
                  <Icon name="download" />
                  <Header.Content>
                    Response Message
                    <Header.Subheader>
                        ...
                        <div className="inherit-width">
                          <Transition transitionOnMount animation="fade" duration={1000}>
                            <div className="inherit-width">
                              <Message icon size="large" info>
                                <Icon name="info circle" />
                                <Message.Content>Canary will generate a {this.state.expectedResponseType} Response Message</Message.Content>
                              </Message>
                            </div>
                          </Transition>
                        </div>
