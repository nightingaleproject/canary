module IjeHelper
  def self.generate_fake_data
    data = {
      ...
      date_of_birth_month: {value: rand(3.years).seconds.ago.strftime("%m"), description: "Date of Birth--Month"},
      date_of_birth_day: {value: rand(3.years).seconds.ago.strftime("%d"), description: "Date of Birth--Day"},
      ...
      marital_status: {value: ['M', 'A', 'W'].sample, description: "Marital Status"},
      ...
      date_of_death_month: {value: rand(3.years).seconds.ago.strftime("%m"), description: "Date of Death--Month"},
      date_of_death_day: {value: rand(3.years).seconds.ago.strftime("%d"), description: "Date of Death--Day"},
      ...
      date_of_registration_month: {value: rand(3.years).seconds.ago.strftime("%m"), description: "Date of Registration--Month"},
      date_of_registration_day: {value: rand(3.years).seconds.ago.strftime("%d"), description: "Date of Registration--Day"},
      ...
      date_of_injury_month: {value: rand(3.years).seconds.ago.strftime("%m"), description: "Date of injury--month"},
      date_of_injury_day: {value: rand(3.years).seconds.ago.strftime("%d"), description: "Date of injury--day"},
